    ...
    <>
      <div className="PreFooter">
        ...
        <div>
          {shieldIcon}
          <p>
            <b>Best Quality Product</b> <br /> We admir your time
          </p>
        </div>
        <div>
          {mapIcon}
          <p>
            <b>Vast service network</b> <br /> 1000 Agrivyapar Centers across
            600 cities
          </p>
        </div>
      </div>
      ...
      <div className="footerBorder">
        <div> Copyright © 2021 - 2022 AgriVyapar. All Rights Reserved</div>
      </div>
    </>
  );
};
