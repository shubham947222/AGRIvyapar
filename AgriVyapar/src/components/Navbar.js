...
const Navbar = () => {
  return (
    <div className="nav">
      ...
      <a className="navlinks" href="/fertilizer">
        Fertilizer
      </a>
      <a className="navlinks" href="/seeds">
        Seeds
      </a>
      <a className="navlinks" href="/waterpumps">
        Water Pumps
      </a>
      <a className="navlinks" href="/machines">
        Machines
      </a>
      {/* <a className="navlinks" href="/redmiphones">
        Redmi Phones
      </a>{" "} */}
      <a className="navlinks" href="/tools">
        Tools
      </a>
